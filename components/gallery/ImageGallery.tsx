        ...
        <div>
            <div className="bg-gray dark:bg-black-light">
                <div className="flex flex-row justify-between">
                    <div className="w-5/6">
                        <h1 className="grow text-center text-gray-50 font-bold text-3xl bg-red-500 rounded-lg p-3">
                            {title}
                        </h1>
                    </div>
                    <div className="flex justify-center items-center">
                        {showCurrent ?
                            <button className="bg-blue-500 p-4 rounded-full" onClick={() => toggleCurrent()}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                                    <path stroke-linecap="round" strokeLinejoin="round" d="M4.5 15.75l7.5-7.5 7.5 7.5" />
                                </svg>
                            </button> :
                            <button className="bg-blue-500 p-4 rounded-full" onClick={() => setCurrent(id)}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
