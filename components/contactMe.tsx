export default function ContactMeComponent() {
  return (
    <div className="relative z-10 rounded-md shadow-md bg-blue text-white p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 -mt-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="md:ml-4 order-2 md:order-1">
          ...
          <div className="icons-container  flex justify-between md:inline-flex flex-row md:flex-col my-20">
            <div className="flex flex-row items-center space-x-6 rounded-md border border-blue hover:border hover:border-aero p-4">
              <svg
        ...
        <form className="form rounded-lg dark:bg-blue p-4 flex flex-col order-1 md:order-2">
          ...
          <input
            type="text"
            className="font-light rounded-md border focus:outline-none py-2 mt-2 px-2 mx-4"
            name="name"
          />
          ...
          <button
            type="submit"
            className="bg-slate-400 m-4 rounded-md w-1/2 mt-8 py-2 text-xs font-bold"
          >
            Send Message
          </button>
        </form>
