  ...
  const processSteps = [
    {
      ...
      description: "We create a couple of format alternatives with the aid of using knowledge of clients requirements, needs, and choices.",
      height: "min-h-64"
    },
    {
      title: "Concepts",
      description: "Considering customers preferences, we create several design concepts for you to choose.",
      height: "min-h-32"
    },
    {
      title: "3D Views",
      description: "After concept confirmation, we only detail and create 3D if necessary.",
      height: "min-h-32"
    },
    {
      title: "Bill of Quality",
      description: "Based on material selection, we create detailed cost estimates for transparency.",
      height: "min-h-32"
    },
    {
      title: "Material Selection",
      description: "According to your budget, we offer material options and combinations that suit your needs.",
      height: "min-h-32"
    }
  ];

  return (
    <section id="design-process" aria-labelledby="design-process-title" className="py-12">
