        ...
        <div>
            <div className="bg-gray dark:bg-black-light">
                <div className="flex flex-row justify-between">
                    <div className="w-5/6">
                        <h1 className="grow text-center text-gray-50 font-bold text-l md:text-3xl bg-red-500 rounded-lg p-3">
                            {title}
                        </h1>
                    </div>
                    <div className="flex justify-center items-center">
                        {showCurrent ?
                            <button className="bg-blue-500 p-1 md:p-4 rounded-full" onClick={() => toggleCurrent()}>
                            ...
                            <button className="bg-blue-500  p-1 md:p-4 rounded-full" onClick={() => setCurrent(id)}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-4 h-4 md:w-6 md:h-6">
