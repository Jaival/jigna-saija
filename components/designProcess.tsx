      ...
      <div className="container mt-5">
        ...
        <div ref={ref} className="container">
          <VerticalTimeline lineColor={theme === 'dark' ? 'white' : 'black'}>
            ...
            >
              <h3 className="font-semibold vertical-timeline-element-title text-l md:text-2xl">
                Layout Options
              </h3>
              {/* <h4 className="vertical-timeline-element-subtitle">Miami, FL</h4> */}
              <p className="text-base">
                We create a couple of format alternatives with the aid of using
                knowledge of clients requirements, needs, and choices.
              </p>
            </VerticalTimelineElement>
            <VerticalTimelineElement
